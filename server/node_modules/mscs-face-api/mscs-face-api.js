...
function MSCSFaceApi(key, server) {
    ...
    /**
     * Retrieve the information of a person, including its name and userData.
     * This API returns person information only.
     * @method module:mscs-face-api.MSCSFaceApi#getPerson
     * @param {String} personGroupId - personGroupId of the target person group.
     * @param {String} personId - personId of the target person.
     * @returns {Promise} A successful call returns the person's information. A unsuccessful call returns the error.
     */
    function getPerson(personGroupId, personId) {
        return new Promise((resolve, reject) => {
            axios({
                method: "get",
